...
import io.pivotal.spring.cloud.gateway.session.SessionConfiguration.HazelcastReactiveSessionConfiguration;
...
class SessionUpdateEntryProcessor implements EntryProcessor<String, String, Boolean>, Offloadable {
    ...
    private static final ObjectMapper objectMapper = HazelcastReactiveSessionConfiguration.getSessionObjectMapper();
