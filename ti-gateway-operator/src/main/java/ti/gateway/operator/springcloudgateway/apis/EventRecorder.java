...
public class EventRecorder {
  ...
  public void logEvent(
      @NotNull V1ObjectReference regardingObjectRef,
      @Nullable V1ObjectReference relatedObjectRef,
      String reason,
      String message,
      EventType type) {
    try {
      CoreV1Event event =
          (new CoreV1Event())
              ...
              .involvedObject(regardingObjectRef)
              .firstTimestamp(OffsetDateTime.now())
              .lastTimestamp(OffsetDateTime.now())
              .reportingInstance(InetAddress.getLocalHost().getHostName())
              .reportingComponent("SpringCloudGatewayController");
      this.coreV1Api.createNamespacedEvent(
          regardingObjectRef.getNamespace(), event, (String) null, (String) null, (String) null);
    ...
    try {
      this.coreV1Api.createNamespacedEvent(
          ...
          (new CoreV1Event())
              ...
              .action("Configuring SpringCloudGateway")
              .message(message),
          (String) null,
          (String) null,
          (String) null);
