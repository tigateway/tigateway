...
public class LeaderElection {
    ...
    public static LeaderElector configureLeaderElector(ApiClient apiClient, OperatorProperties operatorProperties, String appName) {
        ...
        LeaderElectionConfig leaderElectionConfig = new LeaderElectionConfig(lock, Duration.ofMillis(25000L), Duration.ofMillis(20000L), Duration.ofMillis(5000L));
